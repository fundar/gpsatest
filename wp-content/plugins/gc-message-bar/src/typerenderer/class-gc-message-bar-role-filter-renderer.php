...
if(class_exists("Gc_MessageBar_RoleFilter_Renderer")){
    return;
}

class Gc_MessageBar_RoleFilter_Renderer extends Gc_MessageBar_Abstract_Renderer{
    protected $type = "";
            ...
            <?php foreach($this->states as $id => $state){
                ...
                <div class="ad">
                    ...
                    <div class="woolinkblock">
                        <a href="<?php echo $GC_Message_Bar_Config['GCSERVICES']; ?>/gc-message-bar/woothemes/woocommerce" target="_blank">Get WooCommerce</a> <u>or</u> <a href="<?php echo $GC_Message_Bar_Config['GCSERVICES']; ?>/gc-message-bar/woothemes/woocommerce" target="_blank">Learn more</a>
                    </div>
                </div>
            </div> 
