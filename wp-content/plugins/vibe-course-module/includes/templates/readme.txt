...
For more information, see the functions bp_course_load_template_filter() for how template locations
are filtered, and bp_course_screen_one() for how they are loaded for a screen (all in bp-course-core.php)