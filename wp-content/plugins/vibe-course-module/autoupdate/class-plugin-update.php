...
if ( ! defined( 'ABSPATH' ) || class_exists( 'Vibe_Course_Module_Auto_Update' ) )
	return;
 ...
 *
 */
class Vibe_Course_Module_Auto_Update{
	...
	public function dashboard_widget_control_callback() {
		...
		<p>
			<label for="<?php echo $widget_id; ?>-key"><?php _e( 'Themeforest User name ( for Auto-Updates )', 'text-domain' ); ?></label>
		</p>
		<p>
			<input id="<?php echo $widget_id; ?>-key" class="regular-text" name="<?php echo $widget_id; ?>[key]" type="text" value="<?php echo $key_option;?>"/>
		</p>
