<?php 
	...
	if(empty($current_user->membership_level))
		$confirmation_message = "<div class='message'><p>" . __('Your payment has been submitted. Your membership will be activated shortly.', 'pmpro') . "</p></div>";
	else
		$confirmation_message = "<div class='message'><p>" . sprintf(__('Thank you for your membership to %s. Your %s membership is now active.', 'pmpro'), get_bloginfo("name"), $current_user->membership_level->name) . "</p></div>";		
