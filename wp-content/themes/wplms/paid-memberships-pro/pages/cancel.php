...
<p>
	<a class="pmpro_yeslink yeslink button" href="<?php echo pmpro_url("cancel", "?confirm=true")?>"><?php _e('Yes, cancel my account', 'pmpro');?></a>
	|
	<a class="pmpro_nolink nolink button primary" href="<?php echo pmpro_url("account")?>"><?php _e('No, keep my account', 'pmpro');?></a>
</p>
<?php } else { ?>
