<?php
	...
	<div id="pmpro_account">		
		<div id="pmpro_account-membership" class="pmpro_box">
			<div class="message"><p><?php _e("Your membership is <strong>active</strong>.", "pmpro");?></p></div>
			<hr />
		...
		<div id="pmpro_account-profile" class="pmpro_box">	
			...
			<h3 class="heading"><?php _e("My Account", "pmpro");?></h3>
			...
			<p>
				<a href="<?php echo admin_url('profile.php')?>" class="button small"><?php _e("Edit Profile", "pmpro");?></a> |
				<a href="<?php echo admin_url('profile.php')?>" class="button primary small"><?php _ex("Change Password", "As in 'change password'.", "pmpro");?></a>
			</p>
		...
		<?php
			...
			if(!empty($ssorder->id) && $ssorder->gateway != "check" && $ssorder->gateway != "paypalexpress" && $ssorder->gateway != "paypalstandard" && $ssorder->gateway != "twocheckout")
			{
				...
				<div id="pmpro_account-billing" class="pmpro_box">
					<h3 class="heading"><?php _e("Billing Information", "pmpro");?></h3>
		...
		<div id="pmpro_account-invoices" class="pmpro_box">
			<h3 class="heading"><?php _e("Past Invoices", "pmpro");?></h3>
			<ul class="pmpro_account_list">
				<?php 
					$count = 0;
		...
		<div id="pmpro_account-links" class="pmpro_box">
			<h3 class="heading"><?php _e("Member Links", "pmpro");?></h3>
			<ul class="pmpro_account_list">
				<?php 
