...
class WC_Widget_Advanced_Layered_Nav extends WP_Widget {
	 ...
	 * @return void
	 */
	function WC_Widget_Advanced_Layered_Nav() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'vibe_woocommerce_layered_nav', $this->widget_name, $widget_ops );
	}
...
class WC_Widget_Advanced_Layered_Nav_Filters extends WP_Widget {
	 ...
	 * @return void
	 */
	function WC_Widget_Advanced_Layered_Nav_Filters() {
		...
		/* Create the widget. */
		$this->WP_Widget( 'vibe_woocommerce_layered_nav_filters', $this->widget_name, $widget_ops );
	}
...
class vibe_woocommerce_carousels extends WP_Widget {
    ...
    function vibe_woocommerce_carousels() {
		...
		$this->WP_Widget( 'vibe_woocommerce_carousels', __('Vibe WooCommerce Carousels', 'vibe'), $widget_ops, $control_ops );
	}
...
class vibe_woocommerce_mega_carousel extends WP_Widget {
    ...
    /** constructor -- name this the same as the class above */
    function vibe_woocommerce_mega_carousel() {
		...
		$this->WP_Widget( 'vibe_woocommerce_mega_carousel', __('Vibe WooCommerce Mega Carousel', 'vibe'), $widget_ops, $control_ops );
	}
