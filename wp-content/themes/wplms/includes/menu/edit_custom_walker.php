	    ...
	    <li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes ); ?>">
	        ...
	        <div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
                ...
                <p class="field-custom description description-wide on_off_mega">
                    <label><?php _e('Enable Widgetized Mega Menu','vibe') ?></label> <a href="#" class="on_off <?php if(strlen($item->sidebar)>3)echo 'active'; ?>"></a>
                </p>    
	            <p class="field-custom custom description-wide sidebar select-sidebar  <?php if(strlen($item->sidebar)>3)echo 'active'; ?>">
                ...
                <p class="field-custom description-thin sidebar sidebar-columns  <?php if(strlen($item->sidebar)>3)echo 'active'; ?>">
	                <label for="edit-menu-item-columns-<?php echo $item_id; ?>">
	                    <?php _e( 'Sidebar Columns','vibe' ); ?>
                            <select id="edit-menu-item-sidebar-<?php echo $item_id; ?>" name="menu-item-columns[<?php echo $item_id; ?>]">
