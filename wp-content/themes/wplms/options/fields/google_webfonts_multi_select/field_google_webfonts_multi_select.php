...
class VIBE_Options_google_webfonts_multi_select extends VIBE_Options{	
	...
	*/
	function render(){
		...
		echo '</select>';
                  echo  '<span class="right-description"><i class="icon-refresh"></i><a id="reset-google-fonts" class="reset">Refresh Google Webfont List</a> <small> * Updates the font list with latest available Google fonts.</small></span>';
