...
if ( ! class_exists('VIBE_Options') ){
	...
	if(!defined('VIBE_OPTIONS_DIR')){
		define('VIBE_OPTIONS_DIR', $fslashed_dir);
	}
	
	if(!defined('VIBE_OPTIONS_URL')){
		define('VIBE_OPTIONS_URL', site_url(str_replace( $fslashed_abs, '', $fslashed_dir )));
	}
				...
				echo '<div id="vibe-opts-main">';
					...
					if(true === $this->args['show_import_export']){
						echo '<div id="import_export_default_section_group'.'" class="vibe-opts-group-tab">';
							...
							echo '<p><a href="javascript:void(0);" id="vibe-opts-import-code-button" class="button-secondary">Import from file</a> <a href="javascript:void(0);" id="vibe-opts-import-link-button" class="button-secondary">Import from URL</a></p>';
